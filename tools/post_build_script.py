    ...
    if board_id is not None or family_id is not None:
        ...
        if pack_flash_algo is not None:
            ...
            new_hex_file.puts(program_target_addr,struct.pack('<' + program_target_fmt,
                                                            ...
                                                            pack_flash_algo.symbols['EraseChip'] + blob_header_size + flash_blob_entry if pack_flash_algo.symbols['EraseChip'] != int('0xffffffffL', 0) else 0,
                                                            ...
                                                            pack_flash_algo.symbols['Verify'] + blob_header_size + flash_blob_entry if pack_flash_algo.symbols['Verify'] != int('0xffffffffL', 0) else 0,
            ...
            board_info_flag = 1 if pack_flash_algo.symbols['EraseSector'] != int('0xffffffffL', 0) else 0  #kEnablePageErase 
